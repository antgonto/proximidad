index.controller("login_controller", function ($scope, $http) {
  ...
  //Login
  //Manda a verificar los datos del form y si funcionó entonces redirije a la pagina de Cuenta
  ...
  //Crear usuario
  //Manda los datos del form para crear un usuario, si devuelve OK entonces muestra la confirmacion
